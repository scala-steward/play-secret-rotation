...
lazy val crossCompileScala213 = crossScalaVersions := Seq(scalaVersion.value, "2.13.5")
...
val awsSdkForVersion = Map(
  1 -> "com.amazonaws" % "aws-java-sdk-ssm" % "1.11.1003",
  2 -> "software.amazon.awssdk" % "ssm" % "2.16.46"
)
